...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Main Title
	$app_title = "Ardwells Developments System";

	// Build for development purposes
	$build_version 	= date("d.m.Y", filemtime("$path_to_root/CHANGELOG.txt"));

	// Powered by
	$power_by 		= "Ardwells Developments System";
	$power_url 		= "http://ardwells.com";
	...
	// 	context help feed from ardwells.com
	$help_base_url = 'http://ardwells.com/fawiki/index.php?n=Help.';
